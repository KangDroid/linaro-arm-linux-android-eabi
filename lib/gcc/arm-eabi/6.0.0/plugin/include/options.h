...
enum opt_code
{
  ...
  OPT_mcallee_super_interworking = 1158,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1159,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1160,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1161,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1162,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1163,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1164,                  /* -mfp16-format= */
  OPT_mfpu_ = 1165,                          /* -mfpu= */
  /* OPT_mhard_float = 1166, */              /* -mhard-float */
  OPT_mlittle_endian = 1167,                 /* -mlittle-endian */
  OPT_mlong_calls = 1168,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1169,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1170,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1171,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1172,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1173,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1174,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1175,               /* -mprint-tune-info */
  OPT_mrestrict_it = 1176,                   /* -mrestrict-it */
  OPT_msched_prolog = 1177,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1178,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1179,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1180, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1181,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1182,                         /* -mthumb */
  OPT_mthumb_interwork = 1183,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1184,                  /* -mtls-dialect= */
  OPT_mtp_ = 1185,                           /* -mtp= */
  OPT_mtpcs_frame = 1186,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1187,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1188,                         /* -mtune= */
  OPT_munaligned_access = 1189,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1190,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1191,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1192,              /* -mword-relocations */
  OPT_n = 1193,                              /* -n */
  OPT_no_canonical_prefixes = 1194,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1195,              /* -no-integrated-cpp */
  OPT_no_pie = 1196,                         /* -no-pie */
  ...
  OPT_pie = 1209,                            /* -pie */
  OPT_pipe = 1210,                           /* -pipe */
  OPT_print_file_name_ = 1211,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1212,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1213,          /* -print-multi-directory */
  OPT_print_multi_lib = 1214,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1215,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1216,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1217,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1218,               /* -print-prog-name= */
  OPT_print_search_dirs = 1219,              /* -print-search-dirs */
  OPT_print_sysroot = 1220,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1221,   /* -print-sysroot-headers-suffix */
