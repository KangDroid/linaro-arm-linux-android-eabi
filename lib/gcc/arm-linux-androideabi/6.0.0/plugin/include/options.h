...
enum opt_code
{
  ...
  OPT_Winteger_division = 268,               /* -Winteger-division */
  ...
  OPT_Wlto_type_mismatch = 287,              /* -Wlto-type-mismatch */
  OPT_Wmain = 288,                           /* -Wmain */
  OPT_Wmasked_catch_block = 289,             /* -Wmasked-catch-block */
  OPT_Wmaybe_uninitialized = 290,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_transposed_args = 291,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 292,         /* -Wmisleading-indentation */
  ...
  OPT_Woverride_init_side_effects = 325,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 326,                             /* -Wp, */
  ...
  OPT_Wshift_negative_value = 358,           /* -Wshift-negative-value */
  ...
  OPT_Wspecial_param_hiding = 365,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 366,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 367,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 368,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 369,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 370,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 371,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 372,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 373,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 374,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 375,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 376,          /* -Wstrict-selector-match */
  ...
  OPT_Wtype_hiding = 402,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 403,                    /* -Wtype-limits */
  OPT_Wuncheck = 404,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 405,            /* -Wundeclared-selector */
  OPT_Wundef = 406,                          /* -Wundef */
  OPT_Wunderflow = 407,                      /* -Wunderflow */
  OPT_Wuninitialized = 408,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 409,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 410,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 411,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 412, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 413,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 414,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 415,                         /* -Wunused */
  OPT_Wunused_argument = 416,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 417,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 418,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 419,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 420,                /* -Wunused-function */
  OPT_Wunused_import = 421,                  /* -Wunused-import */
  OPT_Wunused_label = 422,                   /* -Wunused-label */
  OPT_Wunused_local = 423,                   /* -Wunused-local */
  ...
  OPT_Wunused_private = 427,                 /* -Wunused-private */
  OPT_Wunused_result = 428,                  /* -Wunused-result */
  OPT_Wunused_thrown = 429,                  /* -Wunused-thrown */
  OPT_Wunused_value = 430,                   /* -Wunused-value */
  OPT_Wunused_variable = 431,                /* -Wunused-variable */
  OPT_Wuse_without_only = 432,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 433,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 434,             /* -Wuseless-type-check */
  OPT_Wvarargs = 435,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 436,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 437,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 438,   /* -Wvector-operation-performance */
  OPT_Wvirtual_move_assign = 439,            /* -Wvirtual-move-assign */
  OPT_Wvla = 440,                            /* -Wvla */
  OPT_Wvolatile_register_var = 441,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 442,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 443,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 444,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 445,                       /* -Wzerotrip */
  OPT_Xassembler = 446,                      /* -Xassembler */
  OPT_Xlinker = 447,                         /* -Xlinker */
  OPT_Xpreprocessor = 448,                   /* -Xpreprocessor */
  OPT_Z = 449,                               /* -Z */
  OPT_ansi = 450,                            /* -ansi */
  OPT_aux_info = 451,                        /* -aux-info */
  /* OPT_aux_info_ = 452, */                 /* -aux-info= */
  OPT_auxbase = 453,                         /* -auxbase */
  OPT_auxbase_strip = 454,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 455, */             /* -bootclasspath */
  OPT_c = 456,                               /* -c */
  /* OPT_classpath = 457, */                 /* -classpath */
  OPT_coverage = 458,                        /* -coverage */
  OPT_cpp = 459,                             /* -cpp */
  OPT_cpp_ = 460,                            /* -cpp= */
  OPT_d = 461,                               /* -d */
  OPT_dumpbase = 462,                        /* -dumpbase */
  OPT_dumpdir = 463,                         /* -dumpdir */
  OPT_dumpmachine = 464,                     /* -dumpmachine */
  OPT_dumpspecs = 465,                       /* -dumpspecs */
  OPT_dumpversion = 466,                     /* -dumpversion */
  OPT_e = 467,                               /* -e */
  /* OPT_encoding = 468, */                  /* -encoding */
  OPT_export_dynamic = 469,                  /* -export-dynamic */
  OPT_extdirs = 470,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 471, */               /* -fCLASSPATH= */
  OPT_fPIC = 472,                            /* -fPIC */
  OPT_fPIE = 473,                            /* -fPIE */
  OPT_fRTS_ = 474,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 475,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 476,                   /* -fabi-version= */
  OPT_faccess_control = 477,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 478,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 479,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 480,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 481,                  /* -falign-commons */
  OPT_falign_functions = 482,                /* -falign-functions */
  OPT_falign_functions_ = 483,               /* -falign-functions= */
  OPT_falign_jumps = 484,                    /* -falign-jumps */
  OPT_falign_jumps_ = 485,                   /* -falign-jumps= */
  OPT_falign_labels = 486,                   /* -falign-labels */
  OPT_falign_labels_ = 487,                  /* -falign-labels= */
  OPT_falign_loops = 488,                    /* -falign-loops */
  OPT_falign_loops_ = 489,                   /* -falign-loops= */
  OPT_fall_intrinsics = 490,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 491, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 492,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 493,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 494, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 495, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 496, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 497, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 498, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 499,            /* -fasan-shadow-offset= */
  OPT_fasm = 500,                            /* -fasm */
  OPT_fassert = 501,                         /* -fassert */
  OPT_fassociative_math = 502,               /* -fassociative-math */
  OPT_fassume_compiled = 503,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 504,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 505,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 506,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 507,                   /* -fauto-profile */
  OPT_fauto_profile_ = 508,                  /* -fauto-profile= */
  OPT_fautomatic = 509,                      /* -fautomatic */
  OPT_faux_classpath = 510,                  /* -faux-classpath */
  OPT_fbackslash = 511,                      /* -fbackslash */
  OPT_fbacktrace = 512,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 513,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 514,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 515,              /* -fbootstrap-classes */
  ...
  OPT_fcall_saved_ = 525,                    /* -fcall-saved- */
  OPT_fcall_used_ = 526,                     /* -fcall-used- */
  OPT_fcaller_saves = 527,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 528,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 529,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 530,                /* -fcheck-data-deps */
  OPT_fcheck_new = 531,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 532,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 533,               /* -fcheck-references */
  OPT_fcheck_ = 534,                         /* -fcheck= */
  OPT_fchkp_check_incomplete_type = 535,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 536,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 537,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 538,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 539,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 540,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 541,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 542, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 543,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 544,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 545,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 546, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 547,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 548,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 549,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 550,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 551,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 552,                       /* -fcilkplus */
  OPT_fclasspath_ = 553,                     /* -fclasspath= */
  OPT_fcoarray_ = 554,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 555,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 556,                         /* -fcommon */
  OPT_fcompare_debug = 557,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 558,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 559,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 560,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 561,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 562,                  /* -fcond-mismatch */
  OPT_fconserve_space = 563,                 /* -fconserve-space */
  OPT_fconserve_stack = 564,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 565,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 566,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 567,                       /* -fconvert= */
  ...
  OPT_fdevirtualize_at_ltrans = 595,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 596,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 597, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 598,             /* -fdiagnostics-color= */
  ...
  OPT_fdirectives_only = 602,                /* -fdirectives-only */
  OPT_fdisable_ = 603,                       /* -fdisable- */
  OPT_fdisable_assertions = 604,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 605,            /* -fdisable-assertions= */
  ...
  OPT_femit_class_file = 631,                /* -femit-class-file */
  OPT_femit_class_files = 632,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 633,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 634,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 635,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 636,                        /* -fenable- */
  OPT_fenable_assertions = 637,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 638,             /* -fenable-assertions= */
  OPT_fencoding_ = 639,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 640,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 641, */           /* -fenum-int-equiv */
  OPT_fexceptions = 642,                     /* -fexceptions */
  OPT_fexcess_precision_ = 643,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 644,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 645,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 646,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 647,                       /* -fextdirs= */
  OPT_fextended_identifiers = 648,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 649,                /* -fextern-tls-init */
  OPT_fexternal_blas = 650,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 651, */       /* -fexternal-templates */
  OPT_ff2c = 652,                            /* -ff2c */
  OPT_ffast_math = 653,                      /* -ffast-math */
  OPT_ffat_lto_objects = 654,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 655,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 656,               /* -ffinite-math-only */
  OPT_ffixed_ = 657,                         /* -ffixed- */
  OPT_ffixed_form = 658,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 659,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 660,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 661,                    /* -ffloat-store */
  OPT_ffor_scope = 662,                      /* -ffor-scope */
  /* OPT_fforce_addr = 663, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 664,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 665,              /* -fforward-propagate */
  OPT_ffp_contract_ = 666,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 667,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 668,                      /* -ffpe-trap= */
  OPT_ffree_form = 669,                      /* -ffree-form */
  OPT_ffree_line_length_ = 670,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 671,          /* -ffree-line-length-none */
  OPT_ffreestanding = 672,                   /* -ffreestanding */
  OPT_ffriend_injection = 673,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 674,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 675,                   /* -ffunction-cse */
  OPT_ffunction_sections = 676,              /* -ffunction-sections */
  OPT_fgcse = 677,                           /* -fgcse */
  OPT_fgcse_after_reload = 678,              /* -fgcse-after-reload */
  OPT_fgcse_las = 679,                       /* -fgcse-las */
  OPT_fgcse_lm = 680,                        /* -fgcse-lm */
  OPT_fgcse_sm = 681,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 682,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 683,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 684,                         /* -fgnu-tm */
  OPT_fgnu_unique = 685,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 686,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 687,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 688,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 689,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 690,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 691,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 692,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 693,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 694,                       /* -fgraphite */
  OPT_fgraphite_identity = 695,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 696,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 697, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 698, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 699,           /* -fhash-synchronization */
  /* OPT_fhelp = 700, */                     /* -fhelp */
  /* OPT_fhelp_ = 701, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 702,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 703, */                /* -fhonor-std */
  OPT_fhosted = 704,                         /* -fhosted */
  /* OPT_fhuge_objects = 705, */             /* -fhuge-objects */
  OPT_fident = 706,                          /* -fident */
  OPT_fif_conversion = 707,                  /* -fif-conversion */
  OPT_fif_conversion2 = 708,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 709,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 710,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 711,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 712,             /* -fimplicit-templates */
  OPT_findirect_classes = 713,               /* -findirect-classes */
  OPT_findirect_dispatch = 714,              /* -findirect-dispatch */
  OPT_findirect_inlining = 715,              /* -findirect-inlining */
  ...
  OPT_finline_matmul_limit_ = 728,           /* -finline-matmul-limit= */
  ...
  OPT_fplt = 858,                            /* -fplt */
  OPT_fplugin_arg_ = 859,                    /* -fplugin-arg- */
  OPT_fplugin_ = 860,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 861,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 862,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 863,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 864,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 865,                   /* -fpreprocessed */
  OPT_fpretty_templates = 866,               /* -fpretty-templates */
  OPT_fprofile = 867,                        /* -fprofile */
  OPT_fprofile_arcs = 868,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 869,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 870,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 871,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 872,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 873,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 874,                 /* -fprofile-report */
  OPT_fprofile_use = 875,                    /* -fprofile-use */
  OPT_fprofile_use_ = 876,                   /* -fprofile-use= */
  OPT_fprofile_values = 877,                 /* -fprofile-values */
  OPT_fprotect_parens = 878,                 /* -fprotect-parens */
  OPT_frandom_seed = 879,                    /* -frandom-seed */
  OPT_frandom_seed_ = 880,                   /* -frandom-seed= */
  OPT_frange_check = 881,                    /* -frange-check */
  OPT_freal_4_real_10 = 882,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 883,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 884,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 885,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 886,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 887,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 888,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 889,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 890,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 891,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 892,                /* -frecord-marker=8 */
  OPT_frecursive = 893,                      /* -frecursive */
  OPT_freduced_reflection = 894,             /* -freduced-reflection */
  OPT_free = 895,                            /* -free */
  OPT_freg_struct_return = 896,              /* -freg-struct-return */
  /* OPT_fregmove = 897, */                  /* -fregmove */
  OPT_frename_registers = 898,               /* -frename-registers */
  OPT_freorder_blocks = 899,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 900,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 901,              /* -freorder-functions */
  OPT_frepack_arrays = 902,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 903,           /* -freplace-objc-classes */
  OPT_frepo = 904,                           /* -frepo */
  OPT_freport_bug = 905,                     /* -freport-bug */
  OPT_frequire_return_statement = 906,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 907,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 908, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 909,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 910,                    /* -fresolution= */
  OPT_frounding_math = 911,                  /* -frounding-math */
  OPT_frtti = 912,                           /* -frtti */
  ...
  OPT_fsaw_java_file = 918,                  /* -fsaw-java-file */
  ...
  OPT_fshort_double = 949,                   /* -fshort-double */
  ...
  OPT_fsource_filename_ = 962,               /* -fsource-filename= */
  OPT_fsource_ = 963,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 964,          /* -fsplit-ivs-in-unroller */
  ...
  OPT_fstore_check = 983,                    /* -fstore-check */
  ...
  OPT_fsync_libcalls = 990,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 991,                    /* -fsyntax-only */
  OPT_ftabstop_ = 992,                       /* -ftabstop= */
  /* OPT_ftarget_help = 993, */              /* -ftarget-help */
  OPT_ftarget_ = 994,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 995,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 996, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 997,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 998,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 999, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 1000,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1001,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1002,                   /* -ftime-report */
  OPT_ftls_model_ = 1003,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1004,              /* -ftoplevel-reorder */
  OPT_ftracer = 1005,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1006,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1007,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1008,                 /* -ftrapping-math */
  OPT_ftrapv = 1009,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1010,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1011,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1012,                      /* -ftree-ccp */
  OPT_ftree_ch = 1013,                       /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 1014,    /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1015,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1016,                /* -ftree-copy-prop */
  OPT_ftree_copyrename = 1017,               /* -ftree-copyrename */
  OPT_ftree_cselim = 1018,                   /* -ftree-cselim */
  OPT_ftree_dce = 1019,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1020,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1021,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1022,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1023,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1024, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1025,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1026,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1027,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1028,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1029,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1030, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1031,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1032,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1033,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1034,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1035,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1036,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1037,                      /* -ftree-pre */
  OPT_ftree_pta = 1038,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1039,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1040, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1041,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1042,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1043,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1044,                     /* -ftree-slsr */
  OPT_ftree_sra = 1045,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1046, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1047, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1048,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1049,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1050,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1051, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1052,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1053, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1054,                      /* -ftree-vrp */
  OPT_funderscoring = 1055,                  /* -funderscoring */
  OPT_funit_at_a_time = 1056,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1057,              /* -funroll-all-loops */
  OPT_funroll_loops = 1058,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1059,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1060,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1061,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1062,                 /* -funsigned-char */
  OPT_funswitch_loops = 1063,                /* -funswitch-loops */
  OPT_funwind_tables = 1064,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1065,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1066,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1067,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1068,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1069,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1070,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1071,                   /* -fuse-ld=gold */
  OPT_fuse_ld_mcld = 1072,                   /* -fuse-ld=mcld */
  OPT_fuse_linker_plugin = 1073,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1074,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1075,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1076,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1077,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1078,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1079, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1080,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1081,                   /* -fverbose-asm */
  /* OPT_fversion = 1082, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1083,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1084,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1085,                   /* -fvisibility= */
  OPT_fvpt = 1086,                           /* -fvpt */
  /* OPT_fvtable_gc = 1087, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1088, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1089,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1090,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1091,                     /* -fvtv-debug */
  OPT_fweak = 1092,                          /* -fweak */
  OPT_fweb = 1093,                           /* -fweb */
  /* OPT_fwhole_file = 1094, */              /* -fwhole-file */
  OPT_fwhole_program = 1095,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1096,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1097,             /* -fworking-directory */
  OPT_fwpa = 1098,                           /* -fwpa */
  OPT_fwpa_ = 1099,                          /* -fwpa= */
  OPT_fwrapv = 1100,                         /* -fwrapv */
  /* OPT_fxref = 1101, */                    /* -fxref */
  /* OPT_fzee = 1102, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1103,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1104,                     /* -fzero-link */
  OPT_g = 1105,                              /* -g */
  OPT_gant = 1106,                           /* -gant */
  OPT_gcoff = 1107,                          /* -gcoff */
  OPT_gdwarf = 1108,                         /* -gdwarf */
  OPT_gdwarf_ = 1109,                        /* -gdwarf- */
  OPT_gen_decls = 1110,                      /* -gen-decls */
  OPT_ggdb = 1111,                           /* -ggdb */
  OPT_ggnu_pubnames = 1112,                  /* -ggnu-pubnames */
  OPT_gnat = 1113,                           /* -gnat */
  OPT_gnatO = 1114,                          /* -gnatO */
  OPT_gno_pubnames = 1115,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1116,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1117,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1118,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1119,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1120,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1121,                   /* -gsplit-dwarf */
  OPT_gstabs = 1122,                         /* -gstabs */
  OPT_gstabs_ = 1123,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1124,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1125,                        /* -gtoggle */
  OPT_gvms = 1126,                           /* -gvms */
  OPT_gxcoff = 1127,                         /* -gxcoff */
  OPT_gxcoff_ = 1128,                        /* -gxcoff+ */
  OPT_gz = 1129,                             /* -gz */
  OPT_gz_ = 1130,                            /* -gz= */
  OPT_h = 1131,                              /* -h */
  OPT_idirafter = 1132,                      /* -idirafter */
  OPT_imacros = 1133,                        /* -imacros */
  OPT_imultiarch = 1134,                     /* -imultiarch */
  OPT_imultilib = 1135,                      /* -imultilib */
  OPT_include = 1136,                        /* -include */
  OPT_iplugindir_ = 1137,                    /* -iplugindir= */
  OPT_iprefix = 1138,                        /* -iprefix */
  OPT_iquote = 1139,                         /* -iquote */
  OPT_isysroot = 1140,                       /* -isysroot */
  OPT_isystem = 1141,                        /* -isystem */
  OPT_iwithprefix = 1142,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1143,              /* -iwithprefixbefore */
  OPT_k8 = 1144,                             /* -k8 */
  OPT_l = 1145,                              /* -l */
  OPT_lang_asm = 1146,                       /* -lang-asm */
  OPT_mabi_ = 1147,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1148,             /* -mabort-on-noreturn */
  OPT_mandroid = 1149,                       /* -mandroid */
  OPT_mapcs = 1150,                          /* -mapcs */
  OPT_mapcs_float = 1151,                    /* -mapcs-float */
  OPT_mapcs_frame = 1152,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1153,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1154,              /* -mapcs-stack-check */
  OPT_march_ = 1155,                         /* -march= */
  OPT_marm = 1156,                           /* -marm */
  OPT_masm_syntax_unified = 1157,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1158,                    /* -mbig-endian */
  OPT_mbionic = 1159,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1160,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1161,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1162,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1163,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1164,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1165,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1166,                  /* -mfp16-format= */
  OPT_mfpu_ = 1167,                          /* -mfpu= */
  OPT_mglibc = 1168,                         /* -mglibc */
  /* OPT_mhard_float = 1169, */              /* -mhard-float */
  OPT_mlittle_endian = 1170,                 /* -mlittle-endian */
  OPT_mlong_calls = 1171,                    /* -mlong-calls */
  OPT_mmusl = 1172,                          /* -mmusl */
  OPT_mneon_for_64bits = 1173,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1174,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1175,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1176,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1177,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1178,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1179,               /* -mprint-tune-info */
  OPT_mrestrict_it = 1180,                   /* -mrestrict-it */
  OPT_msched_prolog = 1181,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1182,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1183,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1184, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1185,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1186,                         /* -mthumb */
  OPT_mthumb_interwork = 1187,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1188,                  /* -mtls-dialect= */
  OPT_mtp_ = 1189,                           /* -mtp= */
  OPT_mtpcs_frame = 1190,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1191,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1192,                         /* -mtune= */
  OPT_muclibc = 1193,                        /* -muclibc */
  OPT_munaligned_access = 1194,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1195,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1196,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1197,              /* -mword-relocations */
  OPT_n = 1198,                              /* -n */
  OPT_no_canonical_prefixes = 1199,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1200,              /* -no-integrated-cpp */
  OPT_no_pie = 1201,                         /* -no-pie */
  OPT_nocpp = 1202,                          /* -nocpp */
  OPT_nodefaultlibs = 1203,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1204,                   /* -nostartfiles */
  OPT_nostdinc = 1205,                       /* -nostdinc */
  OPT_nostdinc__ = 1206,                     /* -nostdinc++ */
  OPT_nostdlib = 1207,                       /* -nostdlib */
  OPT_o = 1208,                              /* -o */
  OPT_p = 1209,                              /* -p */
  OPT_pass_exit_codes = 1210,                /* -pass-exit-codes */
  /* OPT_pedantic = 1211, */                 /* -pedantic */
  OPT_pedantic_errors = 1212,                /* -pedantic-errors */
  OPT_pg = 1213,                             /* -pg */
  OPT_pie = 1214,                            /* -pie */
  OPT_pipe = 1215,                           /* -pipe */
  OPT_posix = 1216,                          /* -posix */
  OPT_print_file_name_ = 1217,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1218,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1219,          /* -print-multi-directory */
  OPT_print_multi_lib = 1220,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1221,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1222,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1223,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1224,               /* -print-prog-name= */
  OPT_print_search_dirs = 1225,              /* -print-search-dirs */
  OPT_print_sysroot = 1226,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1227,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1228,                        /* -profile */
  OPT_pthread = 1229,                        /* -pthread */
  OPT_quiet = 1230,                          /* -quiet */
  OPT_r = 1231,                              /* -r */
  OPT_rdynamic = 1232,                       /* -rdynamic */
  OPT_remap = 1233,                          /* -remap */
  OPT_s = 1234,                              /* -s */
  OPT_s_bc_abi = 1235,                       /* -s-bc-abi */
  ...
  OPT_static_libgcj = 1245,                  /* -static-libgcj */
